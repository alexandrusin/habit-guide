export default function Logo(props: any) {
	return (
		<svg
			...
			y="0px"
			viewBox="0 0 100 100"
			aria-labelledby="logo logo_description"
			role="img"
			{...props}
		>
			<title id="logo">Habit Guide</title>
			<desc id="logo_description">
				Head icon viewed from profile and two arrows surrounding it in
				circular motion.
			</desc>
			{/* head */}
			<g>
